 ...
 * Aug 2016 v3.1: cleanup, add sainsmart adapter by haz <hazridi@gmail.com>
 ************************************************************/
...
#define RASP      4 // DIY
#define BUGRASP   5 // DIY
#define SYDZ      6 // ?
#define YWROBOT   6 // ebay
#define SAINSMART 6 // ebay or microcenter
#define MJKDZ     7 // www.mjkdz.com

class LiquidCrystal_I2C : public Print
{
public:
	LiquidCrystal_I2C(uint8_t lcd_Addr, uint8_t lcd_cols, uint8_t lcd_rows, uint8_t displayadapter = YWROBOT);
